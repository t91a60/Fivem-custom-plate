--- IMAGE CONFIG HERE ---
imageUrl = "" -- Paste your image URL here (doesn't have to be from imgur) 1200x700
...
local object = CreateDui('', 540, 300) -- 2d model for the plate -- paste URL image 1200x700
local handle = GetDuiHandle(object) -- Gets DUI handle from object
